...
uis.directive('uiSelectMultiple', ['uiSelectMinErr','$timeout', function(uiSelectMinErr, $timeout) {
  return {
    ...
    controller: ['$scope','$timeout', function($scope, $timeout){
      ...
      ctrl.protectFlag = false;
      ctrl.setActiveMatchIndex = function (index) {
        if (ctrl.protectFlag) {
          return;
        }

        ctrl.protectFlag = true;
        ctrl.activeMatchIndex = index == ctrl.activeMatchIndex ? -1 : index;
        $select.activate();
...
// 多选input中选中的选项
$templateCache.put("bootstrap/match-multiple.tpl.html","<span class=\"ui-select-match\"><span ng-repeat=\"$item in $select.selected\"><span class=\"ui-select-match-item btn btn-default btn-xs\" tabindex=\"-1\" type=\"button\" ng-disabled=\"$select.disabled\" ng-class=\"{\'btn-primary\':$selectMultiple.activeMatchIndex === $index, \'select-locked\':$select.isLocked(this, $index)}\" ui-select-sort=\"$select.selected\"><span class=\"close ui-select-match-close\" ng-hide=\"$select.disabled\" ng-click=\"$selectMultiple.removeChoice($index)\">&nbsp;&times;</span> <span ng-click=\"$selectMultiple.setActiveMatchIndex($index)\" tooltip data-toggle=\"tooltip\" title=\"{{tooltips}}\" uis-transclude-append=\"\"></span></span></span></span>");
// 单选input
...
// 多选input
$templateCache.put("bootstrap/select-multiple.tpl.html","<div class=\"ui-select-container ui-select-multiple ui-select-bootstrap dropdown form-control\" ng-class=\"{open: $select.open}\"><div><div class=\"ui-select-match\"></div><input type=\"text\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search input-xs\" placeholder=\"{{$selectMultiple.getPlaceholder()}}\" ng-disabled=\"$select.disabled\" ng-hide=\"$select.disabled\" ng-click=\"$select.activate()\" ng-model=\"$select.search\" role=\"combobox\" aria-label=\"{{ $select.baseTitle }}\" ondrop=\"return false;\"><i class=\"caret pointer\" ng-hide=\"$select.selected.length || $select.open\" style=\"position:absolute;top:15px;right:12px;\" ng-click=\"$select.toggle($event)\"></i></div><div class=\"ui-select-choices\"></div></div>");
